...
public class QueueParameters implements Serializable {
     ...
     *                    queue name
     * @param password    the password for the rabbitMQ server with access to the given
     *                    queue name
     * @param virtualHost the virtual host on the rabbitMQ server where new message
     ...
     * @param routingKey  the routing key / token that is exchanged when message is
     *                    transferred
     */
    public QueueParameters(String queueHostIP, String queueName, String username, String password,
                           String virtualHost, String port, String exchange, String routingKey) {
        this.queueHostIP = queueHostIP;
